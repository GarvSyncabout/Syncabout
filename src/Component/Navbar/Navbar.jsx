...
const Navbar = () => {
  ...
  return (
    <>
      <header class=" flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 shadow-md  dark:bg-neutral-800">
            ...
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
              {navLinks.map((navLink, index) => {
                return (
                  <>
                    <Link
                      class="font-bold font-Pontano text-base text-black hover:text-[#ef7f1a] focus:outline-none"
                      to={navLink.href}
                      aria-current="page"
                      key={index}
                    >
                  ...
                  <>
                    ...
                    >
                      <button
                        ...
                        type="button"
                        class="hs-dropdown-toggle font-Pontano font-bold text-base flex items-center w-full text-black hover:text-[#ef7f1a] focus:outline-none focus:text-black  dark:text-neutral-400 dark:hover:text-[#ef7f1a] dark:focus:text-black"
                        aria-haspopup="menu"
                        aria-expanded="false"
                      ...
                      >
                        {dropdownLink.subHeading.map(
                          (subHeadingLinks, index) => {
                            return (
                              <>
                                <Link
                                  key={index}
